...
CREATE TABLE `publicacion` (
  ...
  KEY `FK5bofto4x1u4bfn6k3u40expqq` (`id_emprendimiento`),
  KEY `FK9kh5k6pnpbv4xeqrdwv4585b7` (`id_usuario`),
  CONSTRAINT `FK5bofto4x1u4bfn6k3u40expqq` FOREIGN KEY (`id_emprendimiento`) REFERENCES `emprendimiento` (`id_emprendimiento`),
