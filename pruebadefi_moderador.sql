...
CREATE TABLE `moderador` (
  ...
  `id_moderador` bigint NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id_moderador`),
  KEY `FK9b6wp3m9cpqe9xtsvsmsllsy8` (`id_usuario`),
  CONSTRAINT `FK9b6wp3m9cpqe9xtsvsmsllsy8` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`)
