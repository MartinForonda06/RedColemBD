...
CREATE TABLE `mensaje` (
  ...
  `id_conversacion` bigint DEFAULT NULL,
  `id_mensaje` bigint NOT NULL AUTO_INCREMENT,
  `contenido` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id_mensaje`),
  KEY `FKgdkmmb0imo98aihe9e0t9tjxu` (`id_conversacion`),
  KEY `FKdic7ewqu7vimup6dp2hbu8x5e` (`id_usuario`),
  CONSTRAINT `FKdic7ewqu7vimup6dp2hbu8x5e` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`),
