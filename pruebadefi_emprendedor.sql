...
CREATE TABLE `emprendedor` (
  ...
  `id_emprendedor` bigint NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id_emprendedor`),
  KEY `FK7thyk1a92ses8ktjg9pkd9rbm` (`id_usuario`),
  CONSTRAINT `FK7thyk1a92ses8ktjg9pkd9rbm` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`)
