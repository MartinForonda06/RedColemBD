...
CREATE TABLE `emprendimiento` (
  ...
  `id_emprendimiento` bigint NOT NULL AUTO_INCREMENT,
  ...
  KEY `FKa9941l53mix140i87i29v215d` (`id_departamento`),
  KEY `FKrqwmlmmg9682jed90rsdbeqro` (`id_usuario`),
  CONSTRAINT `FKa9941l53mix140i87i29v215d` FOREIGN KEY (`id_departamento`) REFERENCES `departamento` (`id_departamento`),
  CONSTRAINT `FKrqwmlmmg9682jed90rsdbeqro` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id_usuario`)
